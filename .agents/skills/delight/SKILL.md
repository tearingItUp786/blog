...
name: delight
description:
  Add moments of joy, personality, and unexpected touches that make interfaces
...
that transform functional interfaces into delightful experiences.
...
audience (critical), desired use-cases (critical), brand personality (playful vs
professional vs quirky vs elegant), and what's appropriate for the domain.
...
Do NOT proceed until you have answers. Delight that's wrong for the context is
worse than no delight at all.
...
3. **Define delight strategy**:
   ...
   - **Helpful surprises**: Anticipating needs before users ask (productivity
     tools)
...
**CRITICAL**: Delight should enhance usability, never obscure it. If users
notice the delight more than accomplishing their goal, you've gone too far.
...
- Personality in loading messages ("Herding pixels..." "Teaching robots to
  dance...")
...
**IMPORTANT**: Match copy personality to brand. Banks shouldn't be wacky, but
they can be warm.
...
**IMPORTANT**: File size matters. Compress images, optimize animations, lazy
load delight features.
...
Remember: Delight is the difference between a tool and an experience. Add
personality, surprise users positively, and create moments worth sharing. But
always respect usability - delight should enhance, never obstruct.
