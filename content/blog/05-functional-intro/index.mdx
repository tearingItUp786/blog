...
<TextLink href="https://en.wikipedia.org/wiki/Category_theory">Category
Theory</TextLink>{' '} to our code. This is code that by definition is backed by
hundreds of years of mathematical research and discoveries. I admittedly don't
know much Category Theory but the idea of my code being mathematically provable
to work correctly sure as hell beats the alternative of "well, I'm pretty sure
this works because my tests pass". That about covers the what but beyond FP
being declarative, there are other reasons why I think it leads to more
maintainable and ultimately better code:
