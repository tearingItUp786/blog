...
&nbsp; allowed us to write asynchronous code that appeared to be synchronous! In
fact, it's not so hard to create our own generator consumer (like Co) and I did
just that, I wrote my own example that you should be able to run in Node 😁.
