...
implement a sort of strangler pattern in my current employer's codebase—choking
out old code with new code 😭. This pattern and its implementation are something
