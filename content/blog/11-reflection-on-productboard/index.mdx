...
<InlineImage
  ...
  src="https://res.cloudinary.com/dinypqsgl/image/upload/c_fill,e_auto_brightness,g_center,h_853,w_1280/v1692652742/blog/person-meditating_fyvawu.jpg"
...
time there, the things I learned, and most importantly, the people I met who
...
tech, and some of it related to non technical things such as office politics—all
of it useful for my career. I'll start the discussion with the technical things
that I learned and dovetail into the non technical pieces after that. Feel free
to skip either section.

## How to manage technical debt

In my previous blog post about technical debt, I mentioned how I was utilizing
...
develop software at Productboard and business case for allocating engineering
...
the very real problem I was trying to solve was scalability.
...
LaunchDarkly for implementing feature flags inside of a codebase—I had no real
need for them in any of my previous projects. Nevertheless, I am so grateful
that I was exposed to this wonderful platform!

Feature flags give us the capability to run not only experiments and A/B tests
with our software products but also the ability to disable functionality. We
used these flags not only for running experiments during my time at Productboard
...
Imposter syndrom is the unassuming evil twin of ego.
