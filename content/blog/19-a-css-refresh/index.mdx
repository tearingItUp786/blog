...
applicable to area of my life. As a developer and Brazilian Jiu Jitsu practitioner,

### Invoke the beginner's mindset
...
this means you have no prior knowledge of the topic, you don't know what you don't know, and aga, for myself, it means
seeking out resources and instructors that are beginner-friendly.

The instructor provides a structured learning environment, provides philophsical guidance and the reasoning behind why things
are they way that they are, and can provide details that you just don't get from learning while doing. Hence, I convinced my HR department to
purchase a license for me to relearn some CSS.

If you are are not familiar with Josh Comeau, he's a lovely guy who is, at least as far as I'm concerned,
...
provides you with an introduction to a specific CSS topic/conncept, in course examples that you can play with, and sometimes,
...
You have to attempt to use the knoweldge you've picked up in in a real-world scenario.
...
playground to experiment with your newfound knowledge and apply it to a real-world scenario. Now I'm not saying that my website
