...
Already, I know right? A blog post about implementing an image/media carousel?
What is this, the early 2000s 😂?! Well it's not and I work for a commerce company so this is one case where
having a media gallery totally makes sense -- people want to see images of what they're potentially going to buy! While it's true that we already have a media gallery implementation on our PDPs at [Best Buy](https://bestbuy.ca),
