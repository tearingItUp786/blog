...
<CloudinaryHeroImage containerClassName="aspect-[1280/905]" alt="The Matrix" src="https://res.cloudinary.com/dinypqsgl/image/upload/v1680036005/blog/matrix_xzioyr.jpg" />
...
At the time of this blog post, all major browsers ship with a <TextLink href="https://mzl.la/3sgLt4m">WebAssembly global object</TextLink> that allow us to load in and utilize WASMs.
