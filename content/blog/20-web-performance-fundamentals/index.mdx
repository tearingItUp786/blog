...
2. 😴 If people are _bored_, waiting feels slower.
3. 😬 If people are _anxious_, waiting feels slower.
4. 🤔 _Unexplained_ waiting feels slower.
5. 🕰️ _Uncertain_ waiting feels slow — tell them how long a thing could take.
...
The TLDR of that table, if you didn't go through it 😅:
...
accomplished by, assuming the resource is an image or something to that effect, by using a `<link>` tag to preload our image asset...
