...
with all that being said, I'm trying to hammer home the idea that we need to set goals with **purpose**. For example,
if we are able to see a correlation with our business metrics, say, our conversion on our e-commerce store dip
whenever there's a huge increase in CLS, maybe that's worth looking into? I'm not saying that a bad CLS score
is causing the dip in conversion but it is worth investigating for sure.

In addition to investigating the business impact of our web vitals, don't forget
