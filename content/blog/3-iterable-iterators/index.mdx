...
<TextLink href="https://www.npmjs.com/package/co">Co</TextLink> and <TextLink href="http://bluebirdjs.com/docs/getting-started.html">Bluebird</TextLink>
allowed us to write asynchronous code that appeared to be synchronous! In fact, it's not so hard to create our own generator consumer (like Co) and I did just that, I
