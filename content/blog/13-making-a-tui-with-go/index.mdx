...
is that I wanted to make a TUI because I thought it would be fun. because AI is
the latest buzzword and I wanted to be part of the hype train 🚄.
...
I don't have fully grasp on what is going on in my `Makefile` yet, but I've got
