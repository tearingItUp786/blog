...
pattern because it forces you to handle your errors. However, if you choose not
...
&nbsp;<TextLink href="https://github.com/goreleaser/goreleaser-cross">
goreleaser-cross</TextLink> and set the `CGO_ENABLED` environment variable to
`1` in my `.goreleaser.yml` file. I also eliminated the binaries for `linux` and
`windows` because, well, I didn't want to have to support them 😅.
