...
<Callout
  type="warning"
  title="Heads up:"
  description="this blog post isn't really going to dig into code"
/>

**Yes, it is my birthday 🎈**, but anyway this post isn't about that... or maybe
it is? Or maybe i can be...? hahaha no no! It's about attending conferences!
...
watched the conference from the comfort of my own home instead of spending money
to travel to beautiful Park City, Utah. Technically true, but there's something
special about being in the same room as the speakers and other attendees. The
...
felt. However, that framing was terrible! Thank God for Kent and his "you can
sit with us" attitude/t-shirt/sign. Seeing that sign reminded me that these
...
my sweat on with a BBJ class let me get a feel for the people in Park City. I
...
here... intimidation is _so_ unnecessary when meeting people in or outside of
industry! Despite being "celebrities", they were all so easy to talk to. Hell,
Kent upon seeing me, gave me a big hug; it was so awesome 🙏🏽🤗!
...
for this... but I don't have his twitter handle 😕).
...
morals, and human existence overall; it was one of my favorite conversations
during my stay in Utah 😄.

### Workshops

If your budget allows for it, I defnitely suggest that you go and check them
out! I learned
about&nbsp;<TextLink href="https://www.sanity.io/">Sanity.io</TextLink> and it's
...
friend&nbsp;<TextLink href="https://twitter.com/mannyvirdi">Manjot</TextLink>
once thought we could do that for a living 😂), but I'm one step closer to being
_able_ to do that after that workshop
with&nbsp;<TextLink href="https://twitter.com/simeonGriggs">Simeon</TextLink>
and <TextLink href="https://twitter.com/kmelve">Knut</TextLink> 👀.
...
same content we went over during the workshop day 🧐.
...
to blind players</TextLink>, we can sure as Hell make our websites accessible to
everyone 💪🏽 (or we can at least try).
...
here because some of the most talked about talks (tryiing saying that 5 times
fast) were Ryan Florence's talk on `let vs const`
and&nbsp;<TextLink href="https://twitter.com/jacobmparis">Jacob's</TextLink>
talk on High Performance CRUD apps. I seriously recommend that you to check them
