...
<code style="font-size:14px"><span class="token punctuation" style="color: rgb(255, 255, 255); font-size: 14px;">{</span>
  <span class="token comment" style="color: rgb(92, 99, 112); font-size: 14px;">/* Doing this via tailwind is a little bit more verbose but it's the same idea. Notice, no absolute positioning! */</span>
<span class="token punctuation" style="color: rgb(255, 255, 255); font-size: 14px;">}</span>
