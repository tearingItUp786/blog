...
the OG <TextLink href="https://webpack.js.org/">Webpack</TextLink> to, <TextLink href="https://rollupjs.org/">Rollup</TextLink> to the new kid on the
...
However, you can leverage esbuild and plug it into a webpack config 
and via <TextLink href="https://github.com/privatenumber/esbuild-loader">esbuild-loader</TextLink>
I did this at work today and it helped with devserver startup times and greatly
improved the production build times.
