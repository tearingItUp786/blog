...
you should be listening to a page `visbility change`. <TextLink href="https://developers.google.com/web/updates/2018/07/page-lifecycle-api#the-unload-event">Read more here</TextLink>
