...
- [Cleanshot X](https://cleanshot.sjv.io/7ar4rV) - My screenshotting app.
- [Discord](https://discord.com) - My main chat app.
- [Wispr Flow](https://ref.wisprflow.ai/taranveer786) - Voice to text app, but on steroids.
- [1password](https://1password.com) - My password manager.
- [Spotify](https://spotify.com/) - My music streaming service.
...
- [My Dot Files](https://github.com/tearingItUp786/dotfiles) - My dotfiles
  repository.
- [Ghostty](https://ghostty.org/) - my terminal emulator of choice.
