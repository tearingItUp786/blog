				...
				<AnimatePresence mode="wait">
					{isLastResultSuccessful ? (
						...
						>
							...
							<H3 className="mt-4 mb-2 flex-[1_0_100%]">
							...
							>
								...
								<div className="flex flex-wrap gap-1 self-start">
									...
									<input
										...
										className="outline-border-color focus:outline-accent w-full rounded-xs bg-transparent p-2 outline transition-colors duration-150 focus:outline-2"
									/>
								...
								<div className="flex flex-wrap gap-1 self-start">
									...
									<input
										...
										className="outline-border-color focus:outline-accent w-full rounded-xs bg-transparent p-2 outline transition-colors duration-150 focus:outline-2 data-[invalid=true]:self-center"
								...
								<button
									...
									data-invalid={form.status === 'error'}
									className="hover:bg-dark-gray-200 focus:outline-accent dark:hover:bg-off-white mt-4 mb-0 basis-1/4 cursor-pointer self-end rounded-sm bg-black px-6 py-2 text-white transition-colors duration-150 focus:outline-2 focus:outline-offset-2 disabled:cursor-not-allowed disabled:opacity-60 data-[invalid=true]:mt-0.5 data-[invalid=true]:mb-0 data-[invalid=true]:self-center md:mt-0 md:mb-1 dark:bg-white dark:text-black"
								>
