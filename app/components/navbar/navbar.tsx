...
const HomeIcon = () => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} fill="none">
			<g clipPath="url(#a)">
				<path
					className="fill-body-text group-hover:fill-accent dark:group-hover:fill-accent transition-colors"
...
export function Navbar() {
	...
	return (
		<div className="relative mx-auto flex min-h-[55px] w-full max-w-(--breakpoint-xl) justify-between px-4 pt-8 md:px-20">
			<NavLink
				aria-label="Link to home page"
				prefetch="intent"
				className={`normal lg:dark:text-charcoal-gray group text-charcoal-gray hover:text-pink! focus:text-pink! dark:text-off-white flex items-center justify-center text-center text-xl transition-[color] duration-300 lg:bg-transparent`}
			...
			<div
				className={clsx(
					...
					'fixed top-[63px] left-0 z-20 w-[100vw] origin-top-right justify-center space-y-4 transition-transform lg:relative lg:top-[inherit] lg:flex lg:w-auto lg:space-y-0',
				)}
			>
				<NavLink
					prefetch="intent"
			...
			<div className="relative flex w-[80px] grow items-center justify-end md:pr-0 lg:grow">
