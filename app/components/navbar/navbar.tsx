...
const HomeIcon = () => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} fill="none">
			<g clipPath="url(#a)">
				<path
					className="fill-body group-hover:fill-accent dark:group-hover:fill-accent transition-colors"
...
export function Navbar() {
	...
	return (
		<div className="relative z-30 mx-auto flex min-h-13.75 w-full max-w-screen-xl justify-between px-4 pt-8 md:px-20 lg:z-auto">
			<NavLink
