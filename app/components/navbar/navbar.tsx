	...
	return (
		<div className="relative mx-auto flex min-h-[55px] w-full max-w-screen-xl justify-between px-4 pt-8 md:px-20">
			<NavLink
				...
				prefetch="intent"
				className={`normal lg:dark:charcoal-gray group flex items-center justify-center text-center text-xl text-charcoal-gray transition-[color] duration-300 hover:!text-pink focus:!text-pink dark:text-off-white lg:bg-transparent`}
