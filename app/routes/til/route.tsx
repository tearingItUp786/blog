...
export default function TilPage() {
	...
	return (
		<div className="mx-auto w-full max-w-(--breakpoint-xl) px-4 md:px-20">
			<H1 className="mt-6 mb-4 md:mt-14 md:mb-10">Today I Learned</H1>
			<div className='relative pb-8 after:absolute after:top-[20px] after:left-[0rem] after:hidden after:h-[calc(100%_-_20px)] after:w-[2px] after:bg-gray-100 after:content-[""] md:pl-24 md:after:block lg:px-[6.5rem] xl:min-w-[1200px] dark:after:bg-white'>
